        ...
        <form className="flex flex-col justify-center w-3/4 max-w-md space-y-3 md:flex-row md:w-full md:space-y-0">
          <div className=" relative ">
            ...
            <input
              ...
              className=" rounded-full flex-1 appearance-none border border-gray-300 w-full py-2 pr-4 pl-10 bg-white dark:bg-neutral-900 dark:placeholder:text-gray-300 text-gray-700 placeholder-gray-500 shadow-xl text-base focus:outline-none focus:ring-2 ring-1 ring-[#34B701] focus:border-transparent "
