    ...
    <div className="mb-5 dark:text-white">
      ...
      <Tabs>
        <TabList className="text-center  mx-auto  flex gap-6 tabs text-gray-600 py-3 duration-500">
          <Tab
            className="font-semibold cursor-pointer  border border-gray-300 dark:text-white rounded-full px-5 py-1 outline-none"
            selectedClassName="text-[#34B701] dark:text-[#34B701]  !border-[#34B701] duration-200"
          >
            Overview
          </Tab>
          <Tab
