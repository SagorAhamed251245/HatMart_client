...
const AllTransactionsTable = ({ transactionsData }) => {
  ...
  return (
    <div
      ...
      className="  mt-10 border dark:border-neutral-500 dark:bg-neutral-900  rounded-xl lg:p-4 px-1 py-4 shadow mb-5"
    >
        ...
        <table className=" w-full border-collapse ">
          ...
          <tbody>
            {transactionsData.map((order) => (
              <tr key={order._id} className="border-b border-gray-300 dark:border-neutral-400 w-full">
