...
const OrderStatics = () => {
  return (
    <div className="mt-8 lg:flex justify-between gap-5 lg:space-y-0 space-y-5">
      <div className="lg:w-[35%] w-full hover:shadow-xl shadow-md p-5 border  dark:border-neutral-500 bg-transparent  rounded duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5  lg:w-[65%] w-full">
        <div className="flex flex-col hover:shadow-xl shadow-md p-5 border  dark:border-neutral-500 bg-transparent  rounded duration-300 w-full">
          ...
          <h4 className="text-lg font-bold mt-5 mb-2 text-gray-600 dark:text-white">
            Completed
          </h4>
