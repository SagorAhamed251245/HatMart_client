    ...
    <form className="flex flex-col justify-end w-fit max-w-md space-y-3 md:flex-row md:w-full md:space-y-0">
      <div className=" relative ">
        ...
        <input
          ...
          className=" rounded-full flex-1 appearance-none border border-gray-300 w-full py-2 pr-4 pl-10 bg-white dark:bg-neutral-800 dark:text-gray-200 text-gray-700 placeholder-gray-500 shadow-xl text-base focus:outline-none focus:ring-2 ring-1 ring-[#34B701] focus:border-transparent"
