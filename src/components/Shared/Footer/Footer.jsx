...
const Footer = () => {
 ...
 <footer className="footer p-10 bg-base-200 text-base-content">
      <div>
      <Image src='https://i.ibb.co/WtbFpmR/logo.png' alt='HatMart-logo'  width={100} height={100}></Image>
        <p>HATMART Limited</p>
        <p> Providing reliable Grocery 2010</p>
      </div>
      <div>
  ...
  <div>
    ...
    <a className="link link-hover">Click Shopping</a>
  </div> 
  <div>
      ...
      <div>
        <div>
          ...
          <div className="form-control w-80">
            <p  className='text-bold'>This is a Grocery Shoap. So You can Buy What You need for your daily life.</p>
  ...
  <div className="items-center grid-flow-col">
    ...
    <p>HATMART Industries Ltd.
Providing reliable HATMART LTD. 2010
